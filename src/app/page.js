...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col">
      ...
      <div className="contato rounded-lg h-48 items-center justify-between bg-[url('../logo.png')]">
        
        <Image src={ Profile } alt="profile-picture" className="rounded-full ml-6" height="160"/>
        <h1  className="text-7xl font-sans text-cyan-50">
          Matheus Oliveira Lima
        </h1>

        <div id="contato" className="flex flex-col text-cyan-600 mr-6 bg-white rounded-lg">
          Contato:
      ...
      <div className="objetivo-profissional rounded-lg mx-12">
        <p className="text-left text-base break-normal">
          ...
          Encontrei na programação uma forma de empregar meu raciocínio lógico,
          acho fascinante como é possível usar essa ferramenta em tantos contextos diferentes para a resolução dos mais diversos problemas.
          Tenho focado no aprimoramento de minhas hard-skills com React, Redux, Hooks, Jest, Node.js, MySQL, arquitetura MSC e TypeScript,
          e nas soft-skills que tangem a comunicação e liderança.
          Vamos nos conectar e ficarei feliz com a oportunidade de por em prática aquilo que venho estudando.  
        </p>
